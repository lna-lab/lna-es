...
1. Validate a dialect file: `lna ops validate operators.xml` (schema in `spec/operators.xsd`)
1. Compile a dialect to core rules: `lna ops compile operators.xml -o dialect.json`
1. Run generation: see `tools/cli-commands.md` and the example control in `examples/control.json`
